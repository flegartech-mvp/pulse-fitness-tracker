...
## Routes / screens used
- `audit/screenshots/final-ready/FitnessTrackerApp/02-dashboard.png` → shown as `pulse.app`
- `audit/screenshots/final-ready/FitnessTrackerApp/04-workouts.png` → shown as `pulse.app/workouts`
- `audit/screenshots/final-ready/FitnessTrackerApp/05-progress.png` → shown as `pulse.app/progress`
- Mobile: `audit/screenshots/final-ready/FitnessTrackerApp/03-mobile.png`
...
- `videos/01-instagram-reel.mp4` (4.5 MB)
- `videos/02-tiktok.mp4` (4.5 MB)
- `videos/03-youtube-short.mp4` (4.5 MB)
- `videos/04-linkedin-demo.mp4` (5.5 MB)
- `videos/05-x-demo.mp4` (4.0 MB)
- `videos/06-facebook-demo.mp4` (5.4 MB)
- `videos/07-github-readme-demo.mp4` (3.0 MB)
- `videos/08-portfolio-hero.mp4` (5.4 MB)
- `videos/gifs/github-readme-demo.gif` (5.6 MB)
- `videos/gifs/short-demo.gif` (8.2 MB)
...
**Screens/routes used:** Dashboard, Workouts, Progress + mobile view.
