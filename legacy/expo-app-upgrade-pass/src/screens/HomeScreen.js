    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          >
            ...
            {freezes > 0 && <Text style={styles.freezeCount}>Freeze x{freezes}</Text>}
      ...
      {canRestoreStreak && (
        <View style={styles.restoreCard}>
          ...
          <Pressable
            ...
            accessibilityLabel={`Request support review for ${savedStreak}-day streak restore`}
            accessibilityRole="button"
          >
      ...
      {loadingList ? (
        <View style={styles.stateCard} accessibilityRole="progressbar">
          ...
          <Text style={styles.stateTitle}>Loading workouts</Text>
          <Text style={styles.stateText}>Pulling in your latest sessions and weekly boss progress.</Text>
        </View>
      ) : error ? (
          ...
          ListEmptyComponent={
            <View style={styles.stateCard}>
              ...
              <Text style={styles.stateText}>
                Log your first session to earn XP, build a streak, and start filling this timeline.
              </Text>
              <AppButton
                label="Start First Workout"
                onPress={() => {
                  void logAnalyticsEvent(user.uid, 'home_cta_tapped', { target: 'workout_empty' });
                  navigation.navigate('Workout');
                }}
                size="sm"
                style={styles.emptyBtn}
                accessibilityLabel="Start first workout"
              />
            </View>
          }
          ListFooterComponent={
